  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 px-3.5 py-2.5 rounded-lg shadow-md border border-slate-800 dark:border-slate-200">
        ...
        <p className="text-[13px] font-bold font-mono mt-1 text-emerald-450 dark:text-emerald-600">
          GHS {data.value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        </p>
        <p className="text-[12px] font-bold text-slate-400 dark:text-slate-500 font-mono">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-2">
          ...
          <div className="relative w-32 h-32 flex-shrink-0 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
              <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider leading-none">Share</span>
          ...
          <div className="flex-1 space-y-2 text-sm w-full">
            {categoryData.map((cat, i) => (
              <div key={i} className="flex items-center justify-between">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-250 font-mono pl-2">
